...
#cons_error = pd.read_csv("Unmerged_data/cons_error_unmerged.csv") #errors for CBGs
...
for i in range(0,num_cbg):
    ...
    ans.to_csv('../synthetic_data/US/CBG/random_pick_with_replacement/{num}.csv'.format(num=str(i+1)),index=False)
