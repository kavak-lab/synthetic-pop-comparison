...
cons = cons.loc[:,'population':'work.no.official_lang'].astype('int64')
inds = indsz
...
for i in range(0,num_cbg):
    ...
    ans.to_csv('../synthetic_data/Canada/DA_ADD/random_pick_with_replacement/{num}.csv'.format(num=str(i+1)),index=False)
