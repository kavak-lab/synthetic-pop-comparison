raw_age_sex <- read.csv(paste0("../census_data/Raw/Canada/DA/age_and_sex/ibl9Vs7h2FRfD_data.csv"),stringsAsFactors = FALSE)
...
raw_ethnic_origin <- read.csv(paste0("../census_data/Raw/Canada/DA/ethnic_origin/Rq4uwNdAGA_data.csv"),stringsAsFactors = FALSE)
...
write.csv(cons_formatted_without_NA_Perc, file = "../census_data/Processed/Canada/DA/cons_canada_da.csv", row.names = FALSE)