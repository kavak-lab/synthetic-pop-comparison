...
age <- read.csv("census_data/us_census_data/census_block_group_data/ACSDT5Y_sex_by_age.csv",stringsAsFactors = FALSE)
...
head(age)
write.csv(age, "preprocessing/processed/processed_sex_age_error.csv", row.names = F)
